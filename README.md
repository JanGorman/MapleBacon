...
The easiest way is to use [Carthage](https://github.com/Carthage/Carthage). In this case add the following to your `Cartfile` and then run `carthage update`:

```ruby
github "zalando/MapleBacon"
```

If you don't like that option, you can add the dependency as a git submodule:
